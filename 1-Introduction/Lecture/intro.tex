...
\caption{Detection of plastic trash in videos, image classification. \textcolor{blue}{(Chagneux et al. 2022), (Krizhevsky et al., 2012)-[\href{https://proceedings.neurips.cc/paper/2012/file/c399862d3b9d6b76c8436e924a68c45b-Paper.pdf}{ImageNet}]}. Code is available at \url{https://github.com/jiweibo/ImageNet}}
\end{figure}
\end{frame}
...
\caption{Automatic detections using Region Proposal Network (bounding box design). \textcolor{blue}{(Ren et al. 2015)-[\href{https://papers.nips.cc/paper/2015/hash/14bfa6bb14875e45bba028a21ed38046-Abstract.html}{Faster-RCNN}]}. Code is available at \url{https://github.com/ShaoqingRen/faster_rcnn}.}
\end{figure}
\end{frame}
...
\caption{Visual Question Answering (VQA) tasks. \textcolor{blue}{(Ben-Younes et al. 2017) - [\href{https://arxiv.org/pdf/1705.06676.pdf}{Mutan}]}.}
\end{figure}
\end{frame}
...
\caption{Predicting the three-dimensional structure that a protein will adopt based solely on its amino acid sequence—the structure prediction component of the "protein folding problem". Performance of AlphaFold on the CASP14 dataset. \textcolor{blue}{(Jumper et al. 2022) - [\href{https://www.nature.com/articles/s41586-021-03819-2}{AlphaFold}]}.}
\end{figure}
\end{frame}
...
\caption{Selected opportunities to reduce GHG emissions from buildings and cities using ML.  \textcolor{blue}{(Rolnick et al. 2022) - [\href{https://dl.acm.org/doi/full/10.1145/3485128}{Tackling Climate Change with Machine Learning}]}.}
\end{figure}
\end{frame}
...
\caption{Selected opportunities to reduce GHG emissions from land use using ML.  \textcolor{blue}{(Rolnick et al. 2022) - [\href{https://dl.acm.org/doi/full/10.1145/3485128}{Tackling Climate Change with Machine Learning}]}.}
\end{figure}
\end{frame}

\begin{frame}{Many other applications}
\begin{itemize}
\item Text or document classification, e.g., spam detection;
\item Natural language processing, e.g., morphological analysis, part-of-speech tagging,  named-entity recognition;
\item Speech recognition, speech synthesis, speaker verification;
\item Optical character recognition (OCR);
\item Computational biology applications, e.g., protein function or structured prediction;
\item Fraud detection (credit card, telephone) and network intrusion;
\item Unassisted vehicle control (robots, navigation);
\item Medical diagnosis;
\item Recommendation systems, search engines, information extraction systems.
\end{itemize}
\end{frame}
