...
{\tiny \href{https://probml.github.io/pml-book/book1.html\#toc}{\structure{(Complete book \& figures)}}}

\vspace{.2cm}

 $\rightharpoondown $M1 Lecture notes - statistical learning introduction and basic topics on regression\\
{\tiny \href{https://sylvainlc.github.io/}{\structure{(Lecture notes)}}}
...
{\tiny \href{https://sylvainlc.github.io/}{\structure{(Experiments)}}}

\vspace{.2cm}

$\rightharpoondown$ Materials on Moodle and  {\tiny \href{https://sylvainlc.github.io/}{\structure{(Github)}}}.
...
\begin{figure}[h]
		...
		\caption{A ROC curve for a  logistic regression classifier 200 additional data points not in the training set. Simulations are inspired by \structure{\href{https://scikit-learn.org/stable/auto\_examples/model\_selection/plot\_roc.html}{(Roc curve with scikit-learn)}} and can be found here \structure{\url{https://sylvainlc.github.io/}}.}
	\end{figure}
\end{frame}
...
\pause
 ...
 {\small
 \begin{itemize}
 \item  The estimation error is \structure{random}. It reflects the discrepancy in terms of $\P$, between the chosen classifier and the "local champion" in $\Cc$.
...
\structure{Objective:}  Provide a theoretical control of $\sup_{f\in \Cc} | \widehat{\Rc}_n(f) - \Rc(f) |$.
...
\begin{frame}
In the case where \structure{$|\Cc| $ is finite, with $|\Cc| \leq N$},
$$
