...
%
%
%\subsection{Hard-margin SVM: the separable case }
...
%
%
%\subsubsection{Back to the Linear SVM} 
%
...
\item \structure{Kernel trick:} avoid the explicit mapping $ \varphi (x )$ by directly computing the inner product  $\langle \varphi (x_1 ) , \varphi(x_2) \rangle_\H$  via the kernel function $k(x_1, x_2)$
